// // 별을 랜덤하게 생성하여 화면에 보여주는 함수ver.1
/* starCSS
.star { position: absolute; top: 0; left: 0; width: 99vw; height: 99vh;  }
.star > i { position: absolute; border-radius: 50%; } */
// function star() {
//     const count = 100;
...
setTimeout(function() {
    // location.replace(link); // webHistory저장X , 뒤로가기X
    location.href= link; // webHistory저장O, 뒤로가기O
}, 7000);